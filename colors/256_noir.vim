...
if has("gui_running") || &t_Co == 256
    ...
    hi String cterm=NONE ctermfg=245 ctermbg=16 gui=NONE guifg=#8a8a8a guibg=NONE
    ...
    hi IncSearch cterm=reverse ctermfg=White ctermbg=White
    hi DiffChange cterm=NONE ctermfg=Red ctermbg=White
    hi DiffText cterm=bold ctermfg=White ctermbg=Red
    hi SignColumn cterm=NONE ctermfg=Red ctermbg=Gray
    ...
    hi PmenuThumb cterm=NONE ctermfg=NONE ctermbg=Gray
    hi SpecialKey cterm=NONE ctermfg=NONE ctermbg=White
    hi MatchParen cterm=NONE ctermfg=NONE ctermbg=Gray
    hi CursorLine cterm=NONE ctermfg=NONE ctermbg=NONE
    hi StatusLine cterm=bold,reverse ctermfg=White ctermbg=NONE
    hi StatusLineNC cterm=reverse ctermfg=Gray ctermbg=NONE
    hi Visual cterm=reverse ctermfg=White ctermbg=NONE
